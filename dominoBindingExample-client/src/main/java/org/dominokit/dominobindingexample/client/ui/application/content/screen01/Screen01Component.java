...
public class Screen01Component
  ...
  private IsMessageDriver<Screen01Component> messageDriver;
  ...
  public void render() {
    ...
    Card card01 = Card.create("Error Binding Example - ClearOnBlue = true")
  ...
  public void onAttach() {
    this.messageDriver = new Screen01ComponentMessageDriverImpl();
