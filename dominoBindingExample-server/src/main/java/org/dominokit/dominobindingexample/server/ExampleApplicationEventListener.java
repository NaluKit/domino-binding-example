...
public class ExampleApplicationEventListener
      ...
      switch (requestEvent.getType()) {
        ...
        case RESOURCE_METHOD_FINISHED:
          ...
          final String resourceName = requestEvent.getUriInfo()
                                                  ...
                                                  .getHandlerClass()
                                                  .getName();
          System.out.println("Example Application -> " + resourceName + ": Method '" + methodName + "' executed. Processing time: " + methodExecution + " ms");
          break;
        case ON_EXCEPTION:
          System.out.println("=====================================================================================================================================================");
